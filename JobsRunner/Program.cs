...
using Havit.OpenAIChatPOC.Services.Jobs;
using Havit.OpenAIChatPOC.JobsRunner.Infrastructure.ApplicationInsights;
...
namespace Havit.OpenAIChatPOC.JobsRunner;
